...
simulation_time_ns = 0.5 ; freq_charge_update_fs = 200 ; freq_traj_output_ps = 10 ; write_charges = False
...
Voltage = 0. # in Volts, units will be internally converted later...
...
MMsys=MM( pdb_list = [ 'nvt_0V_15ns.pdb', ] , residue_xml_list = [ ffdir + 'sapt_residues.xml' , ffdir + 'graph_residue_c.xml', ffdir + 'graph_residue_n.xml' ] , ff_xml_list = [ ffdir + 'sapt_noDB_2sheets.xml', ffdir + 'graph_c_freeze.xml', ffdir + 'graph_n_freeze.xml' ]  )
