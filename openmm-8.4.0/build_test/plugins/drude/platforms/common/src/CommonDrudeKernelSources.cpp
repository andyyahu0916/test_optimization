...
"}\n"
"";
const string CommonDrudeKernelSources::drudeSCF = "KERNEL void minimizeDrudePositions(int numDrude, int paddedNumAtoms, float tolerance, GLOBAL real4* RESTRICT posq,\n"
